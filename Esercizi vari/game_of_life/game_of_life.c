...
#define DIMENSIONE_CAMPO_X 30
#define DIMENSIONE_CAMPO_Y 30
#define VIVA 1
#define MORTA 0
#define EPOCHE 100
#define DELAY_MS 500

void inizializzaCampo(int campo[DIMENSIONE_CAMPO_X][DIMENSIONE_CAMPO_Y]);
...
// Inizializza il campo con valori casuali
void inizializzaCampo(int campo[DIMENSIONE_CAMPO_X][DIMENSIONE_CAMPO_Y])
{
...
int calcolaProssimaEpoca(int campo[DIMENSIONE_CAMPO_X][DIMENSIONE_CAMPO_Y], int prossimoCampo[DIMENSIONE_CAMPO_X][DIMENSIONE_CAMPO_Y])
{
    ...
    for(int i = 0; i < DIMENSIONE_CAMPO_X; i++)
        for(int j = 0; j < DIMENSIONE_CAMPO_Y; j++)
        {
            ...
            if(campo[i][j] != prossimoCampo[i][j]) modificati++;
        }
    return modificati;
}
