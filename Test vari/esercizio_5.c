...
ListaOccorrenze calcolaOccorrenze(Parola parola);
...
int main()
{
    ...
    ListaOccorrenze listaOccorrenze = calcolaOccorrenze(parola);
...
ListaOccorrenze calcolaOccorrenze(Parola parola)
{
    ...
    parola++;
    ListaOccorrenze prossimoCalcolo = calcolaOccorrenze(parola);
